...
# All credits for this class go to https://github.com/anucecszl/Parameter-Calculator-for-CCA
...
class EmpiricalParams(object):
    ...
    def __init__(self, element_list, mol_ratio=None):
        ...
        self.params_list = ['Enthalpy(kJ/mol)', 'std_enthalpy(kJ/mol)', 'Delta(%)', 'Omega', 'Entropy(J/K*mol)', 'Tm(K)',
                        'std_Tm (%)', 'X', 'std_X(%)', 'VEC', 'std_VEC', 'Density(g/com^3)', 'Price(USD/kg)']
